...
// Fetching and rendering transactions
...
function renderTransactions(transactions) {
    ...
    if (!transactionsList) {
        ...
        showAlert("Error: Transactions container not found");
        return;
    }
    ...
    transactions.forEach(transaction => {
        ...
        card.innerHTML = `
            <div class="card-body">
                ...
                <p class="card-text">Amount: $${parseFloat(transaction.amount).toFixed(2)}</p>
                <p class="card-text">Tax: ${transaction.tax_type === 'percentage' ? `${parseFloat(transaction.tax)}%` : `$${parseFloat(transaction.tax).toFixed(2)}`}</p>
                <p class="card-text">Total: $${parseFloat(transaction.total).toFixed(2)}</p>
    ...
    // checking HTML content of transactionsList
    // console.log("Transactions list HTML:", transactionsList.innerHTML);
